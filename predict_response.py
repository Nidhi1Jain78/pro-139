...
def preprocess_user_input(user_input):
    inputwords1=nltk.word_tokenize(user_input)
    inputwords2=get_stem_words(inputwords1,ignore_words)
    inputwords3=sorted(list(set(inputwords3)))
    bag=[]
    bag_of_words = []

    # tokenize the user_input
    for word in words:
        if word in inputwords3:
    ...
    # Input data encoding : Create Bag_of_words for user_input
...
while True:
    ...
    print("YOur response:",user_input)
